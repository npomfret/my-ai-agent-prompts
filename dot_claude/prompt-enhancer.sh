...
TMP_DIR="/Users/nickpomfret/projects/my-ai-agent-prompts/dot_claude/tmp"
COOKIE_FILE="${TMP_DIR}/cookies.txt"
LOG_FILE="/Users/nickpomfret/projects/my-ai-agent-prompts/dot_claude/prompt-enhancer.log"
...
if [[ "$PROMPT" == _* || "$PROMPT" == *_ ]]; then
    ...
    ENHANCEMENT=$(curl -s -X POST http://localhost:3000/enhance?projectId=9fe1344eb798 \
